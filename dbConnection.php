...
/*
$resultadoQuery = db_query('select * from 2ds.ds_usuario where usu_codigo = "celsoxcunha"', $usuario $mysqli);
if($resultadoQuery){
...
// $resultadoQuery = db_query("delete from db2ads where usu_codigo = '$usuario'", $mysqli);
